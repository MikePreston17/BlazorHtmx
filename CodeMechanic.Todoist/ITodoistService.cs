...
public class TodoistService : ITodoistService
{
    ...
    // private ConcurrentDictionary<DateTime, string> json_cache = new ConcurrentDictionary<DateTime, string>();
...
// var http_clients =
//         curlOptionsList.Select(curlOptions =>
//         {
//             var http_client = new HttpClient()
//                 {
//                     DefaultRequestHeaders =
//                     {
//                         Authorization = new AuthenticationHeaderValue("Bearer", curlOptions.bearer_token)
//                     }
//                 }
//                 ;
//             return http_client;
